...
describe 'Commentモデルのテスト', Comment do
  describe 'バリデーションのテスト' do
    ...
    it "post_idがない場合は登録できないこと" do
        ...
        comment1.valid?
        expect(comment1.errors.full_messages).to include("Postを入力してください")
    end
    ...
    it "textがない場合は登録できないこと" do
        ...
        comment1.text = nil
        comment1.valid?
        expect(comment1.errors.full_messages).to include("Textを入力してください")
    end
    ...
    it "textが1001文字以上の場合は登録できないこと" do
        ...
        comment1.valid?
        expect(comment1.errors.full_messages).to include("Textは1000文字以内で入力してください")
    end
  end
end